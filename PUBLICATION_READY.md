...
The repository is prepared for a GitHub public alpha. It requires no productive DID, wallet, passphrase, npm token or API key. npm publication remains `NPM_PUBLICATION_PENDING_SCOPE_OWNERSHIP`.
